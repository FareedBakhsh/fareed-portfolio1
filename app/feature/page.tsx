...
const page = () => {
  ...
  return (
      ...
      <h1 className='text-center font-extrabold justify-center items-center pb-8 pt-28' > Explore More With Tech  Industory</h1>
      {/* <p className='justify-center py-14 '>Explore our cutting-edge features empowered by the latest technology. 
        We integrate innovative solutions to enhance user experience and efficiency. From AI-driven insights to seamless integration across platforms,
         our solutions are designed to optimize performance and deliver measurable results. 
         Embrace the future with us as we continue to innovate and elevate your business operations.
          Experience the power of modern technology tailored to meet your unique needs and propel your success forward. Discover how our advanced features can transform your business today.</p> */}


          <div className="mb-12 md:mb-24 text-center max-w-6xl mx-auto">
          <h1 className="mb-16 font-semibold text-5xl sm:text-7xl xl:text-11xl font-heading">
            <span>Discover Our Exclusive </span>
            <span className=" rounded-lg px-4 inline-block">Features With Emmerging Tech</span>
          </h1>
          {/* <p className="font-semibold text-2xl text- tracking-tight">Your journey to digital excellence starts here.</p> */}
        </div>
    ...
    <div className="font-[sans-serif] bg-gradient-to-r from-purple-800 to-indigo-800 py-12 px-4">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12 max-md:max-w-lg mx-auto">
            <div className="rounded-xl group p-8 text-center bg-orange-500 hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
              ...
              <p className="text-gray-300 group-hover:text-gray-500 text-sm"> We provide the Rrofessionall and  Responsive  Desigin  Dvevelop Within Deadlines </p>
            </div>

            <div className="rounded-xl group p-8 text-center bg-red-400 hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
              ...
              <p className="text-gray-300 group-hover:text-gray-500 text-sm">Your data is protected by the latest technology and advance  security measures.</p>
            </div>

            <div className="rounded-xl group p-8 text-center bg-yellow-800   hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
              ...
              <p className="text-gray-300 group-hover:text-gray-500 text-sm">Our Team  remain active  to suit your needs 24/7 customer support for all your inquiries.</p>
            </div>

            <div className="rounded-xl group p-8 text-center bg-lime-700 hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
              ...
              <p className="text-gray-300 group-hover:text-gray-500 text-sm">Experience blazing-fast performance with our product due to Emmerging Tech.</p>
            </div>

            <div className="rounded-xl group p-8 text-center bg-teal-600 hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
              ...
              <p className="text-gray-300 group-hover:text-gray-500 text-sm">Work internationally ,keep national researchs  that fulfill  to  your needs , Expand your ideas to reach with our global network.</p>
            </div>

            <div className="rounded-xl group p-8  bg-pink-700 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-8 mb-6 inline-block" viewBox="0 0 682.667 682.667">
                <defs>
                  <clipPath id="a" clipPathUnits="userSpaceOnUse">
                    <path d="M0 512h512V0H0Z" data-original="#000000" />
              ...
              <p className="text-gray-300 group-hover:text-gray-500 text-sm"> We work internationaly and get varoius client projects. Deals in various  communication by supportive  your team.</p>
            </div>
          </div>
        </div>
      </div></>
